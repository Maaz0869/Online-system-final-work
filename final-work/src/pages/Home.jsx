    ...
    <main className="min-h-screen bg-white pt-16 md:pt-20">
      ...
      <section className="py-12 bg-[#002147] text-white">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-yellow-400">12k+</h3>
          ...
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-yellow-400">45+</h3>
            <p className="text-sm md:text-base">Departments</p>
          </div>
          <div>
            <h3 className="text-3xl md:text-4xl font-bold text-yellow-400">1st</h3>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#002147]">Our Academic Excellence</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {['Research', 'Academics', 'Admissions'].map((item) => (
            <div key={item} className="p-8 border rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border-gray-100 group">
              ...
              <p className="text-gray-600 text-sm">Providing world-class facilities and education in the heart of Peshawar.</p>
